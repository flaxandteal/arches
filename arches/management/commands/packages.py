...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            action="store_true",
            dest="strict",
            help="Whether all errors should raise exceptions, if possible."
        )
            ...
            for graphid in graphids:
                try:
                    ...
                    data = resource_exporter.export(
                        graph_id=graphid, resourceinstanceids=[resource_id] if resource_id else None, languages=languages
                    )
                    for file in data:
                        with open(
                            os.path.join(
